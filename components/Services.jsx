  ...
  return (
    <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1 }} id="services" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 0.7, duration: 0.5 }} className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
        I'm a fullstack developer from Central Java who loves exploring new technologies and turning ideas into impactful digital solutions for individual, startups, and business.
      </motion.p>
